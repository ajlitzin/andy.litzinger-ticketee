...
Scenario: New project link is hidden from non-signed-in users
...
Scenario: Edit project link is hidden from non-signed-in users
  Given I am on the homepage
  When I follow "TextMate 2"
  Then I should not see the "Edit Project" link

Scenario: Edit project link is hidden from signed-in users
  Given I am signed in as "user@ticketee.com"
  When I follow "TextMate 2"
  Then I should not see the "Edit Project" link
...
Scenario: Delete project link is hidden from non-signed-in users
  Given I am on the homepage
  When I follow "TextMate 2"
  Then I should not see the "Delete Project" link

Scenario: Delete project is hidden from signed-in users
  Given I am signed in as "user@ticketee.com"
  When I follow "TextMate 2"
  Then I should not see the "Delete Project" link
